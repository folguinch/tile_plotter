...
class NPlotter(BasePlotter):
    ...
    def __init__(self, styles=[], rows=1, cols=1, nxcbar=0, nycbar=0, xsize=5, ysize=3, left=.7, 
    ...
    def get_axis(self, nax=0, include_cbar=False):
        axis, cbaxis = super(NPlotter,self).get_axis(nax,
                include_cbar=include_cbar)
        return Plotter(axis, cbaxis)
